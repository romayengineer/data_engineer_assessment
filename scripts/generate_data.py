...
# Random helper data
campanias = ["2023/24", "2024/25", "2025/26"]
...
def generate_clima_diario(num_rows):
    ...
    # Column headers
    columns = ["lote_id", "campania", "fecha", "temp_min_c", "temp_max_c", "precipitacion_mm"]
    ...
    with open(filename, mode="w", newline="", encoding="utf-8") as file:
        ...
        for i in range(1, num_rows + 1):
            ...
            campania = random.choice(campanias)
            ...
            writer.writerow([lote_id, campania, fecha, temp_min, temp_max, precipitacion])
...
def generate_rinde_lotes(num_rows):
    ...
    # Column headers
    columns = ["lote_id", "campania", "fecha", "cultivo", "superficie_ha", "rinde_kg_ha", "humedad_pct"]
    ...
    with open(filename, mode="w", newline="", encoding="utf-8") as file:
        ...
        for i in range(1, num_rows + 1):
            ...
            writer.writerow([lote_id, campania, fecha, cultivo, superficie_ha, rinde_kg_ha, humedad_pct])
